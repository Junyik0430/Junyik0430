                        ...
                        <div class="card-body">
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="p_name" value="{{$products->p_name }}">
                                        @error('p_name')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="p_price" value="{{$products->p_price }}">
                                        @error('p_price')
                                            <div class="text-danger text-xs pt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="p_quantity" value="{{$products->p_quantity }}">
                                        @error('c_email')
                                            <div class="text-danger text-xs pt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <!-- Owner Dropdown -->
                                        <select class="form-control select2"  id='p_owner' name='p_owner' value="{{$products->p_owner }}">
                                        <option value='0'>-- Select Owner --</option>
                                        @foreach($users['data'] as $user)
                                            <option value='{{ $user->username }}' {{$user->username == $products->p_owner ? 'selected':'' }}>{{ $user->username }}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="p_category" value="{{$products->p_category }}">
                                        @error('p_category')
                                            <div class="text-danger text-xs pt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="manufacturer" value="{{$products->manufacturer }}">
                                        @error('manufacturer')
                                            <div class="text-danger text-xs pt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="v_name" value="{{$products->v_name }}">
                                        @error('v_name')
                                            <div class="text-danger text-xs pt-1">{{ $message }}</div>
                                        @enderror
                                    </div>
